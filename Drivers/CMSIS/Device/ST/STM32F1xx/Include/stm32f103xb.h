...
typedef struct
{
  ...
  __IO uint32_t SMPR2;  /* ADC sample time reigster 2                   */
  ...
  __IO uint32_t HTR;    /* ADC watchdog high threshold register         */
  __IO uint32_t LTR;    /* ADC watchdog low threshold register          */
...
{
  uint32_t  RESERVED0;
  __IO uint32_t DR1;    /* Backup data register 1         */
  __IO uint32_t DR2;    /* Backup data register 2         */
  __IO uint32_t DR3;    /* Backup data register 3         */
  __IO uint32_t DR4;    /* Backup data register 4         */
  __IO uint32_t DR5;    /* Backup data register 5         */
  __IO uint32_t DR6;    /* Backup data register 6         */
  __IO uint32_t DR7;    /* Backup data register 7         */
  __IO uint32_t DR8;    /* Backup data register 8         */
  __IO uint32_t DR9;    /* Backup data register 9         */
  __IO uint32_t DR10;   /* Backup data register 10        */
  __IO uint32_t RTCCR;  /* RTC clock calibration register */
  __IO uint32_t CR;     /* Backup control register        */
  __IO uint32_t CSR;    /* Backup control/status register */
} BKP_TypeDef;
...
typedef struct
{
  __IO uint32_t TIR;    /* CAN TX mailbox indentifier register                     */
...
typedef struct
{
  __IO uint32_t RIR;  /* CAN recieve FIFO mailbox identifier register                         */
  __IO uint32_t RDTR; /* CAN recieve FIFO mailbox data length control and time stamp register */
  __IO uint32_t RDLR; /* CAN recieve FIFO mailbox data low register                           */
  __IO uint32_t RDHR; /* CAN recieve FIFO mailbox data high register                          */
...
typedef struct
{
  __IO uint32_t FR1;  /* Filter bank i register 1*/
  __IO uint32_t FR2;  /* Filter bank i register 2*/
...
typedef struct
{
  ...
  __IO uint32_t TSR;                              /* CAN transimt status register         */
  __IO uint32_t RF0R;                             /* CAN recieve FIFO 0 register          */
  __IO uint32_t RF1R;                             /* CAN recieve FIF0 1 register          */
  ...
  CAN_TxMailBox_TypeDef sTxMailBox[3];            /* CAN TX mailbox register              */
  CAN_FIFOMailBox_TypeDef sFIFOMailBox[2];        /* CAN FIFO mailbox register?           */
  ...
  CAN_FilterRegister_TypeDef sFilterRegister[14]; /* filter bank i register x             */
} CAN_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t CPAR;   /* DMA channel x peripheral addres register */
...
typedef struct
{
  __IO uint32_t EVCR;       /* Event control register                           */
  __IO uint32_t MAPR;       /* Alternate-Function remap and debug I/O configuration register 1  */
  __IO uint32_t EXTICR[4];  /* External interrupt configuration register        */
  uint32_t RESERVED0;       /* RESERVED                                         */
  __IO uint32_t MAPR2;      /* Alternate-Function remap and debug I/O configuration register 2  */
} AFIO_TypeDef;
/** 
...
typedef struct
{
  __IO uint32_t CRH;  /* RTC control register high            */
  __IO uint32_t CRL;  /* RTC control register low             */
  __IO uint32_t PRLH; /* RTC prescaler load register high     */
  __IO uint32_t PRLL; /* RTC prescaler load register low      */
  __IO uint32_t DIVH; /* RTC prescaler divider register high  */
  __IO uint32_t DIVL; /* RTC prescaler divider register low   */
  __IO uint32_t CNTH; /* RTC counter register high            */
  __IO uint32_t CNTL; /* RTC counter register low             */
  __IO uint32_t ALRH; /* RTC alarm register high              */
  __IO uint32_t ALRL; /* RTC alarm register low               */
} RTC_TypeDef;
